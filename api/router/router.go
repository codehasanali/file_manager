...
import (
	...
	"github.com/codehasan/file/api/logger"
	"github.com/codehasan/file/api/util"
	"github.com/gin-contrib/cors"

	"github.com/codehasan/file/api/file"
...
func helloRoute(context *gin.Context) {
	context.JSON(http.StatusOK, gin.H{"message": "ok"})
	logger.RouteLog(context.ClientIP(), "GET", "Server run", false)
}
